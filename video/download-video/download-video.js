...
class VideoDownloader {
    ...
    static downloadBlob(blobOrUrl, filename) {
        ...
        methods: {
            ...
            async exportBatchData(type) {
                ...
                const episodeFilter = (item) => {
                    const match = episodeList.find((it) => it.cid === item.cid);
                    if (match === undefined) {
                        return false;
                    }
            ...
            selectAllEpisodes() {
                this.episodeList.forEach((item) => item.checked = true);
            },
            unselectAllEpisodes() {
                this.episodeList.forEach((item) => item.checked = false);
            },
            inverseAllEpisodes() {
                this.episodeList.forEach((item) => item.checked = !item.checked);
            },
        }
    });
