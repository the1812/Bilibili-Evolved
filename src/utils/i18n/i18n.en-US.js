...
export const map = new Map([
  ...
  [`选择分类`, `Category`],
  [`必须选择分类才能开播`, `You can't start live streaming before select a category.`],
  ...
  [`赛事`, `Events`],
  [`启用快速收藏`, `Enable quick favorite`],
  [`快速收藏`, `Q·Favorite`],
  [`选择快速收藏夹:`, `Selected favorite folder:`],
  [`右键点击快速收藏可再次打开`, `Right click to open this dialog again`],
  ...
  [`SEO页面重定向`, `SEO redirect`],
  [`评论翻译`, `Comments translate`],
  [`评论链接复制`, `Copy comments link`],
  [`动态链接复制`, `Copy feeds link`],
  [`开播记录`, `Live history`],
  [`动态反折叠`, `Unfold feeds`],
  [`查看大图`, `Zoom`],
  [`向左旋转`, `Rotate Left`],
  ...
  [`打包下载`, `Packed`],
  [`分别下载`, `Individual`],
  [`多文件下载模式`, `Multiple files download mode`],
  [`专栏图片导出`, `Column image exporter`],
  [`动态图片导出`, `Feeds image exporter`],
  [`导出图片`, `Export images`],
  [`置顶`, `Pin`],
  [`获赞数`, `Likes`],
  [`记笔记`, `Notes`],
...
export const regex = new Map([
  ...
  [/^共([0-1])个视频$/, `$1 video`],
  [/^共([\d]+)个视频$/, `$1 videos`],
  [/^已添加至收藏夹: (.+)$/, `Added to favorite: $1`],
  [/^已移出收藏夹: (.+)$/, `Removed from favorite: $1`],
]);
export default {
  export: { map, regex },
};