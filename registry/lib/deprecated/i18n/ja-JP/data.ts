  ...
  [
    ...
    [
      ...
      },
      {
        ...
        text:
          'エッジの間隔：両側のエッジの間隔をパーセントで設定します.100％は頂欄全体の幅です.許容設定範囲は0％〜40％です.',
      },
      {
        selector: '.custom-navbar-settings .orders-desc',
        text:
          '順序と表示：左側の棒状アイコン上でドラッグすると順序が変更されるか、名前を押しながらドラッグすることで順序を変更することができます。右側の目のアイコンをクリックすると表示され、非表示になります.',
      },
