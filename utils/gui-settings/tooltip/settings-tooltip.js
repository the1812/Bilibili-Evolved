...
注: 旧版布局中, 很多脚本功能将不适用.`,
            ...
            useDefaultDanmakuSettings: `设置默认是否开启弹幕, 以及是否记住弹幕设置, 包括屏蔽类型, 防挡字幕和智能防挡弹幕.`,
            enableDanmaku: `控制弹幕是否默认开启.`,
            rememberDanmakuSettings: `控制是否记住弹幕设置, 包括屏蔽类型, 防挡字幕和智能防挡弹幕. 在播放器中改动这些设置后, 每个视频都会默认使用这些设置.`,
...
注: 关注和等级可以通过鼠标停留在头像上, 在弹出的资料卡小窗中查看. 暂不支持动态里的评论, 以后会加.`,
