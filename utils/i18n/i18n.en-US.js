export const map = new Map([
    ...
    [`所有关注`, `All followings`],
    [`进入专栏区`, `Columns`],
    [`暂时没有新动态了哦！`, `No new activities yet.`],
    [`播放历史`, `History`],
    ...
    [`今天你想了解什么呢？(☆▽☆)`, `What would your want to know?(☆▽☆)`],
    [`请输入弹幕 DA☆ZE～`, `Please enter your danmaku DA☆ZE～`],
    [`有什么想和大家分享的？`, `Share your fancy!`],
    [`有新动态，点击查看`, `New activities, click to view`],
    [`以上为热门评论，`, `Aboves are hot comments`],
    [`请自觉遵守互联网相关的政策法规，严禁发布色情、暴力、反动的言论。`, `Please respect the policies, do not post illegal comments.`],
    [`点击查看`, `Click to view`],
    [`刚刚`, `Just now`],
    [`转发动态`, `Repost`],
    [`分享动态`, `Share`],
    ...
    [`投稿了`, `Posted`],
    [`动态首页`, `Activity Home`],
    [`历史动态`, `Activity History`],
    [`活动作品`, `Event`],
    [`未经作者授权，禁止转载`, `Transfer to other sites is not allowed before authorized`],
    [`上一帧`, `Previous Frame`],
    [`下一帧`, `Next Frame`],
    [`人正在看`, `watching`],
    [`条实时弹幕`, `danmakus`],
    ...
    [`用手机看`, `View on phone`],
    [`弹幕列表`, `Dnamaku List`],
    [`左舷弹幕太薄了，大家快来吐槽吧~`, `Danmaku list is empty. Be the first danmaku!`],
    [`屏蔽设定`, `Block Settings`],
    [`屏蔽列表`, `Block List`],
    ...
    [`同时转发到我的动态`, `Repost to my activities`],
    [`人气值`, `Popularity`],
    [`友爱社`, `Support club`],
    [`话题`, `#Tags#`],
    [`活动`, `Event`],
    ...
    [`不透明度`, `Opacity`],
    [`缩放直播看板娘`, `Scale live room showgirl`],
    ...
    [`颜值领域专属封面`, `顔出し用サムネ`],
    [`私信存档`, `Message Archive`],
    [`历史私信`, `Message History`],
    [`用户中心`, `User center`],
    [`我的信息`, `My messages`],
    [`领取奖励`, `Collect rewards`],
    [`关注直播间`, `Follow`],
    [`加入黑名单`, `Block`],
    [`悄悄关注`, `Private follow`],
    [`个人信息举报`, `Report`],
