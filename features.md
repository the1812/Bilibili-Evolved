...
开启此功能之后，可以通过原生倍速菜单修改可用的扩展倍速：

<img alt="可自定义扩展倍速的倍数菜单" src="https://user-images.githubusercontent.com/34429322/104614831-926a8d00-56c3-11eb-826b-d1190bffa6bd.gif" height="500"></img>

如果通过点击输入框上的步进箭头（不同浏览器的样式可能不同，也可能不被支持）来调整输入框的值，最低值会被限制在当前最高倍数+0.5，最高值会被限制在 16，期间的步进值是 0.5。如果手动输入则没有这样的限制，但输入的倍数值仍然必须在 0.0625 到 16 之间.
