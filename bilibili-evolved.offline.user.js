...
(self$ =>
{
    ...
    $(document).ready(() =>
    {
       ...
       const offlineData = {};
offlineData["https://raw.githubusercontent.com/the1812/Bilibili-Evolved/master/style/style.scss"] = `.bili-wrapper
{
...
`;
offlineData["https://raw.githubusercontent.com/the1812/Bilibili-Evolved/master/style/style-old.scss"] = `.bili-header-m>.nav-menu
{
    background: rgb(0, 86, 177) !important;
    box-shadow: rgba(17, 81, 150, 0.48) 0px 2px 10px 1px !important;
...
`;
offlineData["https://raw.githubusercontent.com/the1812/Bilibili-Evolved/master/style/style-dark.scss"] = `body,
html,
p.num,
...
{
    background-position: 0em -9.376em !important;
}
.bp-svg-icon.radio-Selected
{
    background-position: 0em -8.376em !important;
}
...
`;
offlineData["https://raw.githubusercontent.com/the1812/Bilibili-Evolved/master/style/style-touch-player.scss"] = `.touch-video-box-wrapper
{
    display: flex;
    align-items: center;
...
`;
offlineData["https://raw.githubusercontent.com/the1812/Bilibili-Evolved/master/style/style-navbar-override.css"] = `div.nav-menu
{
...
`;
offlineData["https://raw.githubusercontent.com/the1812/Bilibili-Evolved/master/style/style-no-banner.css"] = `#banner_link
{
    display: none !important;
}
div.blur-bg
...
`;
offlineData["https://raw.githubusercontent.com/the1812/Bilibili-Evolved/master/style/style-gui-settings.scss"] = `.gui-settings-icon-panel
{
    height: 100%;
    display: flex;
    justify-content: center;
